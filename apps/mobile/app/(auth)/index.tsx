...
const styles = StyleSheet.create({
  ...
  card:           { backgroundColor: '#ffffff', borderRadius: 20, padding: 24, borderWidth: 1, borderColor: '#e2e8f0', shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 10, elevation: 2 },
  label:          { color: '#475569', fontSize: 13, fontWeight: '700', marginBottom: 6, marginTop: 14 },
  input:          { backgroundColor: '#f8fafc', borderRadius: 12, padding: 14, color: '#0f172a', fontSize: 15, borderWidth: 1, borderColor: '#cbd5e1' },
  rolePicker:     { flexDirection: 'row', gap: 12, marginTop: 4 },
  roleBtn:        { flex: 1, backgroundColor: '#f8fafc', borderRadius: 12, padding: 16, alignItems: 'center', borderWidth: 1, borderColor: '#e2e8f0' },
  ...
  bgChipActive:   { backgroundColor: 'rgba(239,68,68,0.12)', borderColor: '#ef4444' },
  bgText:         { color: '#475569', fontWeight: '700', fontSize: 13 },
  bgTextActive:   { color: '#ef4444' },
  demoHelper:     { marginTop: 32, alignItems: 'center' },
  demoHelperText: { color: '#64748b', fontSize: 13, marginBottom: 12, fontWeight: '700', textTransform: 'uppercase' },
  demoChips:      { flexDirection: 'row', gap: 12 },
  demoChip:       { backgroundColor: '#ffffff', paddingVertical: 8, paddingHorizontal: 16, borderRadius: 20, borderWidth: 1, borderColor: '#e2e8f0', shadowColor: '#000', shadowOpacity: 0.03, shadowRadius: 4 },
  demoChipText:   { color: '#475569', fontWeight: '700', fontSize: 13 },
});
